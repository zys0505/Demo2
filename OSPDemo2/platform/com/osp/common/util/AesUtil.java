...
public class AesUtil {
    ...
    /**
     * 加密方法，对encrypt进行包装，减少了短语字段、
     * @param key 加密key
     * @param iv 加密向量
     * @param str 带加密字符串
     * @return
     */
    public static String encode(String key,String iv,String str){
    	//不知道这个是干啥的，需要传入
    	String passphrase = "i dont know";
    	return  new AesUtil(128, 1000).encrypt(key, iv, passphrase, str); 
    }
    
    /**
     * 解密方法，对decrypt进行包装，减少了短语字段、
     * @param key
     * @param iv
     * @param str
     * @return
     */
    public static String decode(String key,String iv,String str){
    	//不知道这个是干啥的，需要传入
    	String passphrase = "i dont know";
    	return  new AesUtil(128, 1000).decrypt(key, iv, passphrase, str); 
    }
}
