 ...
 * HMACMD5 算法工具类 
 * 用于消息传递过程中，数据完整性验证
 * @author liudonghe  2017年5月10日 下午4:29:28 
 *
 */
public class MD5Util {
	...
	public static void main(String[] args) {
		// String data="
		// {\"OperatorSecret\":\"1234567890abcdef\",\"OperatorID\":\"MA1K370P7\"}";
		String data = "MA002TMQX"
				+ "pktViMlOXjgrJSk0L6M5n2pTTt2QcZwy+gya92a6SLP3exG+KVuHogTvQjsSvQfsC6zTAnt5yyQLaliyD0dRUw=="
				+ "20160920104450";
		System.out.println(MD5Util.encode("1234567890abcdef", data));
